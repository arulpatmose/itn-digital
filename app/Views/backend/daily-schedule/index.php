        ...
        <div class="block block-rounded" data-controller="<?php echo $controller; ?>" id="daily-schedule-items-wrapper">
            ...
            <div class="block-content block-content-full">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="mb-4">
                            <label class="form-label" for="schedule-filters-platform">Platform<button type="reset" class="btn bg-transparent btn-sm py-0" onclick="clearSelection('schedule-filters-platform')">Reset</button></label>
                            ...
                            <div class="block-content">
                                <div class="row">
                                    ...
                                    <div class="col-md-9 col-lg-9 col-sm-12" data-table-id="<?php echo $index + 1; ?>">
                                        <table class="table table-striped table-hover table-responsive daily-schedule-items-table" id="<?php echo 'data-table-' . $index + 1; ?>">
                                            <thead>
                                                <tr>
