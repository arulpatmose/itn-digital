...
<div class="content">
    <div class="row">
        <div class="col-md-12 col-lg-10 col-xl-8">
            <form action="<?= base_url('transactions/return') ?>" method="POST">
                <?= csrf_field() ?>
                <div class="block block-rounded">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Return Chips</h3>
                        <div class="block-options">
                            <a href="<?= base_url('transactions') ?>" class="btn btn-sm btn-danger">Cancel</a>
                            <button type="submit" class="btn btn-sm btn-secondary">Record Return</button>
                        </div>
                    </div>
                    <div class="block-content">
                        <div class="row py-sm-3 py-md-4">
                            <div class="col-md-10 col-lg-8">
                                <p class="text-muted mb-4">Record chips being returned (e.g. from a producer back to store).</p>
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="from_participant_id">Returned From <small class="text-muted">(optional)</small></label>
                                ...
                                <div class="mb-4">
                                    <label class="form-label" for="to_participant_id">Returned To <small class="text-muted">(optional)</small></label>
                                    <select class="form-select" id="to_participant_id" name="to_participant_id">
