        ...
        <div class="col-12 col-lg-4">
            <div class="block block-rounded">
                <div class="block-header block-header-default">
                    <h3 class="block-title">Chip Details</h3>
                    <div class="block-options">
                        <a href="<?= base_url('chips') ?>" class="btn btn-sm btn-alt-secondary">Back</a>
                        <?php if (auth()->user()->can('chips.edit')): ?>
                            <a href="<?= base_url('chips/edit/' . $chip['id']) ?>" class="btn btn-sm btn-success">Edit</a>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="block-content">
                    <dl class="row mb-0">
                        ...
                        <?php if (!empty($chip['notes'])): ?>
                            ...
                            <dd class="col-sm-8 text-muted"><?= esc($chip['notes']) ?></dd>
                        <?php endif; ?>
                    </dl>
                </div>
            </div>
                ...
                <div class="block-content block-content-full">
                    ...
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-striped table-vcenter w-100" id="table-timeline">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Date</th>
