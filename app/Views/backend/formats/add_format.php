...
<div class="content">
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-6">
            <form action="<?php echo site_url('formats/submit'); ?>" method="POST">
                        ...
                        <div class="row justify-content-center py-sm-3 py-md-5">
                            <div class="col-sm-10 col-md-8">
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" id="format-code" name="format-code" placeholder="Code" required>
                                </div>
                                <div class="mb-4">
                                    <label class="form-label" for="format-name">Format Name</label>
                                    <input type="text" class="form-control" id="format-name" name="format-name" placeholder="Format Name" required>
                                </div>
                            </div>
                        </div>
                    </div>
