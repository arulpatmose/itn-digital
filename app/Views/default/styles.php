...
<!-- Include Plugins and Custom CSS -->
<?= $this->renderSection('other-styles') ?>

<!-- OneUI framework -->
<link rel="stylesheet" id="css-main" href="<?php echo base_url('assets/css/oneui.min.css'); ?>">

<!-- Load and set color theme + dark mode preference (blocking script to prevent flashing) -->
<script src="<?php echo base_url('assets/js/setTheme.js'); ?>"></script>

<!-- Global CSS Code -->
<link rel="stylesheet" href="<?php echo base_url('assets/css/global.css') . '?v=' . time(); ?>">
