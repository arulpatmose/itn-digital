                    ...
                    <tr>
                        <td style="background-color:#ffffff; border-radius:8px; box-shadow:0 1px 4px rgba(0,0,0,.08); overflow:hidden;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="background-color:#2f2f3b; padding:24px 32px;">
                                ...
                                <tr>
                                    <td style="padding:32px;">
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" style="margin:24px auto;">
                                            <tr>
                                                <td align="center" style="background-color:#f0f4ff; border:2px dashed #2f2f3b; border-radius:8px; padding:20px 40px;">
                                                    <span style="font-size:36px; font-weight:800; letter-spacing:10px; color:#2f2f3b; font-family:'Courier New',monospace;">
                                                        <?= esc($code) ?>
                                                    </span>
                                                </td>
                                            </tr>
